...
export default function Shop() {
  ...
  const applyFilters = () => {
    ...
    result = result.filter(
      toy => 
        toy.price >= activeFilters.priceRange[0] && 
        toy.price <= activeFilters.priceRange[1]
    );
    ...
    if (activeFilters.availability) {
      result = result.filter(toy => toy.stock > 0);
    }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-8">
        ...
        <p className="mt-3 max-w-2xl mx-auto text-gray-500 sm:text-lg">
          Browse our collection of high-quality toys available for purchase.
        </p>
      </div>
