...
-- Fix toys policies - check if policies exist before creating them
DO $$
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'toys' AND policyname = 'Anyone can insert toys') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'toys' AND policyname = 'Anyone can update toys') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'toys' AND policyname = 'Anyone can delete toys') THEN
